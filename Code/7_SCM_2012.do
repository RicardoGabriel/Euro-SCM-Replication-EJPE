...
if ("$begin"=="1970") {
	...
	if ("$remove_nr"=="0") {
		foreach var in $outcome $covariates {
			replace `var'cg = `var'cg[_n+43] + `var'cg[_n+86] + `var'cg[_n+129] + `var'cg[_n+172] + `var'cg[_n+215] + `var'cg[_n+258] + `var'cg[_n+301] +`var'cg[_n+344] + `var'cg[_n+387] + `var'cg[_n+430] +`var'cg[_n+473] + `var'cg[_n+516] + `var'cg[_n+559] + `var'cg[_n+602]
		}
	}
}
