...
Table \ref{TA_Gap} presents the exact doppelganger gaps measured in euro per capita. According to our estimates, Ireland benefited the most from the euro adoption. Its GDP per capita was \texteuro10,961 higher due to the common currency adoption. However, France, Germany, Italy, and Portugal would be better off by not participating in this currency union. Yet, Germany and Italy lost the most: \texteuro4,864 and \texteuro7,351 per capita respectively.
...
% Countries that did not implement spending-based austerity measures between 1999 and 2007 were Austria, Belgium, Spain, Finland, and France.
...
%This evidence highlights the importance of analyzing in detail the heterogeneous responses of GDP and its components across Eurozone countries. Given the different responses of investment and government consumption across member states, it is natural to ask if the effectiveness of national fiscal policies has changed after the euro adoption. This could be especially interesting because countries forgo important policy instruments when joining a currency union.
...
%     \includegraphics[scale=1.2]{Output/Figures/SCM_gdp_Rob_1998_Annual.pdf}
